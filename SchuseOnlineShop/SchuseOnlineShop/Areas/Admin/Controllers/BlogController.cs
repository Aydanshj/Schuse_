...
namespace SchuseOnlineShop.Areas.Admin.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        public async Task<FileResult> ExportBlogInExcel()
        {
            var blogs = await _blogService.GetAllAsync();
            var fileName = "blog.xlsx";

            return GenerateExcel(fileName, blogs);
        }

        private FileResult GenerateExcel(string fileName, IEnumerable<Blog> blogs)
        {
            DataTable dataTable = new("Blog");
            ...
            {
                dataTable.Rows.Add(item.Id, item.Title, item.Description, item.Image);
            }
